...
<div class="login-box">
  ...
  <div class="login-box-body">
    ...
    <form role="form" method="post" action="<?php echo e(url('/doLogin')); ?>">
      <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
      <?php if($message=='no_user'): ?>
          <label style="color: red;">user doesn't exist!</label>
      <?php endif; ?>
      <div class="form-group has-feedback">
        <input type="text" name="username" class="form-control" placeholder="Enter Username">
        <span class="glyphicon glyphicon-user form-control-feedback"></span>
      </div>
      <?php if($message=='incorrect_pw'): ?>
          <label style="color: red;">password is incorrect!</label>
      <?php endif; ?>
      <div class="form-group has-feedback">
